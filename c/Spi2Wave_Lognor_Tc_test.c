...
int N=8,M=8,WinHei=35, print=1,coefx=1,coefy=1;   
...
for(ic=0;ic<1;ic++){
    ...
    strcat(filename,"_8by8_wave.dat");	
	strcat(filename2,"_8by8_map.dat");
	...
	CluRadLin(aNoise,   N, M, 'N', rho, phi, aLow, aglobal, sigma);      
    CluRadLin(tauNoise, N, M, 'b', rho, phi, tau_off, tau, 0); 
    CluRadLin(cNoise,   N, M, 'U', rho, phi, cLow, cglobal, sigma);  
