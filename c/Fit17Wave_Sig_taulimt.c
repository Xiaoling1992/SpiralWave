//Test whether wave could propagate when tau_on=10 and 5.
...
fpt=fopen("F17_F2g1_T_taulimit.dat","w");
 fpt1=fopen("F17_F2g1_sta_taulimit.dat","w");
...
for(ic=0;ic<1;ic++){
    ...
    strcat(filename,"_waveR10.dat");	
	strcat(filename2,"_mapR10.dat");
