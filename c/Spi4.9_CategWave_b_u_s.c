...
fptPhase=fopen("Spi4.9_b_Phase_us.dat","w");
fptPeriod=fopen("Spi4.9_b_Period_us.dat", "w");
fptAnc=fopen("Spi4.9_b_Anchor_us.dat", "w");
...
for(ic=0;ic<1;ic++){
  ...
  double FirSamMean=0, FirSamMean_th=0.5, PeakMean=0, PeakMean_th=1.4;
