...
fptPhase=fopen("Spi9_Phase_Tau12Rho95.dat", "w");
fptPeriod=fopen("Spi9_Period_Tau12Rho95.dat", "w");
fptAnc=    fopen("Spi9_Anchor_Tau12Rho95.dat", "w");
fptPhi=    fopen("Spi9_PhiAct_Tau12Rho95.dat", "w");
