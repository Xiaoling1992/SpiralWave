//_example: get the _wave.dat of image: Spi46_bd20t16tf5c10_T60
...
double gamma=0;
double taus[]={16}, sigmas[]={0.03, 0.06, 0.10, 0.13, 0.16, 0.20, 
    0.23, 0.26, 0.30, 0.33, 0.36, 0.40, 0.43, 0.46, 0.50, 0.53, 0.57, 0.60, 0.63, 0.67, 0.70, 0.73, 
    0.77, 0.80, 0.83, 0.87, 0.90, 0.93, 0.97, 1.00};
double anchor, anchors[]={20}; //This is the diameter of the anchor. 

int  Len_taus=1, Len_sigmas=30, Len_rhos=4, NumRep=1, Len_anchors=1;
...
fptPhase=fopen("Spi46_b_Phase_delete.dat","w");
