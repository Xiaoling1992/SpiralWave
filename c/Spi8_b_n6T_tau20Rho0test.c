...
double gamma=0;
double rhos[]={0}, taus[]={12, 16, 19, 20, 22, 40, 240}, sigmas[]={0.42, 0.6};
...
fptPhase=fopen("Spi8_Phase_t20Rho0test.dat", "w");
fptPeriod=fopen("Spi8_Period_t20Rho0test.dat", "w");
fptAnc=    fopen("Spi8_Anchor_t20Rho0test.dat", "w");
