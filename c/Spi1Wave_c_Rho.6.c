...
double tau, taus[]={600, 300, 100, 75, 50, 25, 20, 15, 10, 5};
double cglobal, cs[]={0.1, 0.5, 1, 2, 5, 10, 20, 50, 100};
double gamma=0, phi_real;
double phi,rho, phis[]={0.3, 0.5, 0.6, 0.8};

int  Len_as=1, Len_taus=10, Len_cs=9, Len_phis=4, NumRep=1;
...
int N=100,M=100,WinHei=35, print=1,noise=1,coefx,coefy;   
...
for(ic=0;ic<Len_cs;ic++){
    ...
    strcat(filename,"Rho");   sprintf(num, "%d",(int)(rho*100));strcat(filename,num); 
      ...
      strcat(filename,"cL");  sprintf(num, "%d",(int)(cLow*10));strcat(filename,num);
