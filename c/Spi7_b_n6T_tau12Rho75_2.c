//_2 don't visulize the dynamical anchor size: n6, n7 to speed up the code.
...
fptPhase=fopen("Spi7_n6_Phase_t12Rho75_1.dat", "w");
fptPeriod=fopen("Spi7_n6_Period_t12Rho75_1.dat", "w");
fptAnc=    fopen("Spi7_n6_Anchor_t12Rho75_1.dat", "w");
