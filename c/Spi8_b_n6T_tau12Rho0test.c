...
double gamma=0;
double rhos[]={0}, taus[]={12}, sigmas[]={0.42};
...
fptPhase=fopen("Spi8_Phase_t12Rho0test.dat", "w");
fptPeriod=fopen("Spi8_Period_t12Rho0test.dat", "w");
fptAnc=    fopen("Spi8_Anchor_t12Rho0test.dat", "w");
