//Measure the speed as a function of tau.
...
double gamma=0;
double rhos[]={ 0}, taus[]={5, 6, 7, 8, 9, 10, 12, 14, 16, 19, 22, 26, 30, 36, 42, 49, 57, 67, 79, 92, 108, 127, 149, 174, 204, 
	240, 281, 329, 386, 452, 530, 621, 728, 853, 1000}, phis[]={1.0};
...
fptPeriod=fopen("Spi11_Speed_Tau.dat", "w");
