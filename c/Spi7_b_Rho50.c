...
double gamma=0;
double rhos[]={0.50}, taus[]={10, 12, 14, 16, 19, 22, 26, 30, 36, 42, 49, 57, 67, 79, 92, 108, 127, 149, 174, 204, 
...
int  NumRep=20, Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]),  Len_rhos=sizeof(rhos)/sizeof(rhos[0]),
...
fptPhase=fopen("Spi7_b_Phase_Rho50.dat", "w");
