...
int  Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]),  Len_rhos=sizeof(rhos)/sizeof(rhos[0]), Len_taus=sizeof(taus)/sizeof(taus[0]), Len_sigmas=sizeof(sigmas)/sizeof(sigmas[0]), NumRep=500;
...
fptPhase=fopen("Spi61_b_Phase.dat", "w");
fptPeriod=fopen("Spi61_b_Period.dat", "w");
fptAnc=fopen("Spi61_b_Anchor", "w");
