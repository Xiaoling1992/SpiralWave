...
srand((unsigned) time(&tt));  //Initiating random number generator only once. 
	...
	fptMap=fopen("/home/xiaoling/SpiralWave/data/Spi7_Rho0t240p420c10R11.dat","r"); //It must be "r"
	fptOCC=fopen("/home/xiaoling/SpiralWave/data/Spi7_Rho0t240p420c10R11_OCCin.dat", "w");
    ...
    int state[N*M], cluster[N*M], CluSiz;
		 //Find out the convex hull of the spiral head
	  	  int NumPoiIn, NumCMP=11;  //Accumulative parameter
		  double ConHull[2][NumCMP], SetX[2][11]={ {61, 65, 69, 68, 74, 68, 59, 55, 54, 58, 62},{48, 50, 58, 65, 76, 74, 76, 70, 61, 53, 47}};
