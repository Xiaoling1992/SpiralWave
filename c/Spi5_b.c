...
double gamma=0;
double rhos[]={0}, taus[]={22}, sigmas[]={0.22,0.24,0.26,0.28,0.30,0.32,0.34,0.36,0.38,0.40,0.42,0.44,0.46,0.48,0.50,0.52,0.54,0.56,0.58,0.60,0.62,0.64,0.66,0.68,0.70};
...
fptPhase=fopen("Spi50_b_Phase.dat", "w");
fptPeriod=fopen("Spi50_b_Period.dat", "w");
