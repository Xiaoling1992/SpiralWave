...
double gamma=0;
double rhos[]={0.75}, taus[]={10,1000}, sigmas[]={0.4, 0.5};

int  NumRep=2, Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]),  Len_rhos=sizeof(rhos)/sizeof(rhos[0]),
...
fptPhase=fopen("Spi7_test_Phase_Rho75.dat", "w");
