...
double gamma=0;
double rhos[]={0}, taus[]={240}, sigmas[]={0.26, 0.28,0.30,0.32,0.34,0.36,0.38,0.40,0.42,0.44,0.46,0.48,0.50,0.52,0.54,0.56,0.58,0.60,0.62};
...
fptPhase=fopen("Spi7_n5_Phase_t240.dat", "w");
fptPeriod=fopen("Spi7_n5_Period_t240.dat", "w");
fptAnc=    fopen("Spi7_n5_Anchor_t240.dat", "w");
