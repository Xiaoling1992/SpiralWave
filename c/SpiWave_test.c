...
double aglobal,as[]={0.02};  //WT, trkA, sinR, ktrA
double tau, taus[]={300};
double cglobal, cs[]={0, 1, 10};
double gamma=0, phi_real;
double phi,rho, phis[]={1};

int  Len_as=1, Len_taus=1, Len_phis=1, NumRep=1;
...
fpt=fopen("test_T_100by100_Phi.45Rho.6.dat","w");
 fpt1=fopen("test_sta_100by100_Phi.45Rho.6.dat","w");
