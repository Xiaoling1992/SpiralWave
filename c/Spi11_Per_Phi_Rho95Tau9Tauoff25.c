...
fptPeriod=fopen("Spi11_Period_Phi_Rho95Tau9Tauoff25.dat", "w");
fptPhi=    fopen("Spi11_PhiAct_Phi_Rho95Tau9Tauoff25.dat", "w");
...
for(ic=0;ic<Len_cs;ic++){
	...
	rho=rhos[irho]; 
	tau_off=2.5;	//Tau_off is not applied in LogNormal distribution
	tau=taus[itau]; 
	phi=phis[iphi];    
