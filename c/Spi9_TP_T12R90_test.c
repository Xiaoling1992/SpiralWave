...
fptPhase=fopen("Spi9_Phase_Tau12Rho90_test.dat", "w");
fptPeriod=fopen("Spi9_Period_Tau12Rho90_test.dat", "w");
fptAnc=    fopen("Spi9_Anchor_Tau12Rho90_test.dat", "w");
fptPhi=    fopen("Spi9_PhiAct_Tau12Rho90_test.dat", "w");
...
for(ip=0;ip<NumRep; ip++){         
 ...
 //$$ 4. Change the Trigger Time,length, and number of rows $$$$$$$$$$$$$$$$*//  
  ...
  printf("After solving PDE, time is %ld seconds\n",time(NULL)-tt);
