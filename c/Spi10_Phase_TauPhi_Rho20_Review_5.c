...
double gamma=0;
double rhos[]={0.20}, taus[]={5+EPSILON, 6, 7, 8, 9, 10, 12, 14, 16, 19, 22, 26, 30, 36, 42, 49, 57, 67, 79, 92, 108, 127, 149, 174, 204, 
...
fptPhase=fopen("Spi10_Phase_TauPhi_Rho20_5.dat", "w");
...
for(ip=0;ip<NumRep; ip++){         
 ...
 //$$ 4. Change the Trigger Time,length, and number of rows $$$$$$$$$$$$$$$$*//  
  ...
  double FirSamMean=0, FirSamMean_th=phi;
