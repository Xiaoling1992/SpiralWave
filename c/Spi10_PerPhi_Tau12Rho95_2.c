...
double gamma=0;
double rhos[]={0.95}, taus[]={12}, phis[]={0.58, 0.6 ,  0.62,  0.64,  0.66,  0.68,  0.7 };
...
fptPeriod=fopen("Spi10_Period_Tau12Rho95_2.dat", "w");
fptPhi=    fopen("Spi10_PhiAct_Tau12Rho95_2.dat", "w");
