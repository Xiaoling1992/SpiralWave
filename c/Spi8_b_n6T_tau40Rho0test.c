...
double gamma=0;
double rhos[]={0}, taus[]={40}, sigmas[]={0.42};
...
fptPhase=fopen("Spi8_Phase_t40Rho0test.dat", "w");
fptPeriod=fopen("Spi8_Period_t40Rho0test.dat", "w");
fptAnc=    fopen("Spi8_Anchor_t40Rho0test.dat", "w");
...
printf("Finishing generating the fraction of firing cells, costs %ld seconds of time\n",time(NULL)-tt);
 ...
 printf("Finishing generating the PeakMean, costs %ld seconds of time\n",time(NULL)-tt);
