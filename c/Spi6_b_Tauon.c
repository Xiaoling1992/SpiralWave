...
double gamma=0;
double rhos[]={0}, taus[]={300}, sigmas[]={30,35,41,48,57,66,78,91,107,125,147,172,202,236,277,325,381,446,523,613,719,842,987,1157,1356,1589,1863,2184,2560,3000};
...
fptPhase=fopen("Spi6_b_tanon_Phase.dat", "w");
