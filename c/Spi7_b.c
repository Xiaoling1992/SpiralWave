...
double gamma=0;
double rhos[]={0}, taus[]={10, 12, 14, 16, 19, 22, 26, 30, 36, 42, 49, 57, 67, 79, 92, 108, 127, 149, 174, 204, 
	240, 281, 329, 386, 452, 530, 621, 728, 853, 1000}, sigmas[]={0.13, 0.16, 0.19, 0.22, 0.25, 0.28, 0.31, 0.34,
	0.37, 0.40, 0.43, 0.46, 0.49, 0.52, 0.55, 0.58, 0.61, 0.64, 0.67, 0.70, 0.73, 0.76, 0.79, 0.82, 0.85, 0.88, 0.91,
	0.94, 0.97, 1.00};

int  NumRep=20, Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]),  Len_rhos=sizeof(rhos)/sizeof(rhos[0]), Len_taus=sizeof(taus)/sizeof(taus[0]), Len_sigmas=sizeof(sigmas)/sizeof(sigmas[0]);
...
fptPhase=fopen("Spi7_n6_Phase_t240_2.dat", "w");
fptPeriod=fopen("Spi7_n6_Period_t240_2.dat", "w");
fptAnc=    fopen("Spi7_n6_Anchor_t240_2.dat", "w");
