...
double gamma=0;
double taus[]={240}, sigmas[]={0.22,0.24,0.26,0.28,0.30,0.32,0.34,0.36,0.38,0.40,0.42,0.44,0.46,0.48,0.50,0.52,0.54,0.56,0.58,0.60,0.62,0.64,0.66,0.68,0.70,0.72,0.74,0.76,0.78,0.80,0.82,0.84,0.86,0.88,0.90,0.92,0.94,0.96,0.98,1.00};
...
fptPhase=fopen("Spi47_b_Phase_t240.dat", "w");
fptPeriod=fopen("Spi47_b_Period_t240.dat", "w");
