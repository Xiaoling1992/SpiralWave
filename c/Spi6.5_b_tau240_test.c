...
double gamma=0;
double rhos[]={0}, taus[]={240}, sigmas[]={0.44,0.46,0.48};

int  NumRep=3, Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]),  Len_rhos=sizeof(rhos)/sizeof(rhos[0]), Len_taus=sizeof(taus)/sizeof(taus[0]), Len_sigmas=sizeof(sigmas)/sizeof(sigmas[0]);
...
fptPhase=fopen("Spi6.5_b_Phase_t240_test.dat", "w");
fptPeriod=fopen("Spi6.5_b_Period_t240_test.dat", "w");
fptAnc=    fopen("Spi6.5_b_Anchor_t240_test.dat", "w");
