...
double gamma=0;
double rhos[]={0}, taus[]={240}, sigmas[]={0.40, 0.50};
...
fptPhase=fopen("Spi7_n6_Phase_t240_test.dat", "w");
fptPeriod=fopen("Spi7_n6_Period_t240_test.dat", "w");
fptAnc=    fopen("Spi7_n6_Anchor_t240_test.dat", "w");
