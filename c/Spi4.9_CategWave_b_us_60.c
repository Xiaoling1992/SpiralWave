...
fptPhase=fopen("Spi4.9_b_Phase_us_60.dat","w");
fptPeriod=fopen("Spi4.9_b_Period_us_60.dat", "w");
fptAnc=fopen("Spi4.9_b_Anchor_us.dat_60", "w");
...
for(ic=0;ic<1;ic++){
  ...
  double FirSamMean=0, FirSamMean_th=0.6, PeakMean=0, PeakMean_th=1.4;
