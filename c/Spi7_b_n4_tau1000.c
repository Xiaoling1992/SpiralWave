...
int  NumRep=300, Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]),  Len_rhos=sizeof(rhos)/sizeof(rhos[0]), Len_taus=sizeof(taus)/sizeof(taus[0]), Len_sigmas=sizeof(sigmas)/sizeof(sigmas[0]);
...
fptPhase=fopen("Spi7_n4_Phase_t1000.dat", "w");
fptPeriod=fopen("Spi7_n4_Period_t1000.dat", "w");
fptAnc=    fopen("Spi7_n4_Anchor_t1000.dat", "w");
