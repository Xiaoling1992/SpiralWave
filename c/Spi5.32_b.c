...
double gamma=0;
double rhos[]={0}, taus[]={1000}, sigmas[]={0.26,0.262,0.265,0.268,0.272,0.277,0.283,0.291,0.3,0.311,0.324,0.341,0.361,0.385,0.415,0.452,0.497,0.551,0.618,0.7};
...
fptPhase=fopen("Spi532_b_Phase.dat", "w");
fptPeriod=fopen("Spi532_b_Period.dat", "w");
