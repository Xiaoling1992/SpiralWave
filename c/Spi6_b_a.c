...
double gamma=0;
double rhos[]={0}, taus[]={300}, sigmas[]={0.001,0.002,0.003,0.004,0.005,0.007,0.009,0.011,0.014,0.018,0.023,0.030,0.038,0.048,0.062,0.078,0.100};
...
fptPhase=fopen("Spi6_b_u0_Phase.dat", "w");
