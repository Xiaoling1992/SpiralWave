...
double gamma=0;
double rhos[]={0}, taus[]={12}, sigmas[]={0.42, 0.8};
...
fptPhase=fopen("Spi7_n6_Phase_t12Rho0_1test.dat", "w");
fptPeriod=fopen("Spi7_n6_Period_t12Rho0_1test.dat", "w");
fptAnc=    fopen("Spi7_n6_Anchor_t12Rho0_1test.dat", "w");
...
for(ic=0;ic<Len_cs;ic++){
	...
	sigma=-999;
     ...
     strcat(filename,"_wave_1test.dat");	
    strcat(filename2,"_map_1test.dat");
