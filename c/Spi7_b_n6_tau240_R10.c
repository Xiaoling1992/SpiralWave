//_R10: repeat 10 times for the parameter combination, and save all the spiral wave and map files. 
...
double gamma=0;
double rhos[]={0}, taus[]={240}, sigmas[]={0.42};

int  NumRep=40, Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]),  Len_rhos=sizeof(rhos)/sizeof(rhos[0]), Len_taus=sizeof(taus)/sizeof(taus[0]), Len_sigmas=sizeof(sigmas)/sizeof(sigmas[0]);
...
fptPhase=fopen("Spi7_n6_Phase_t240_R40.dat", "w");
fptPeriod=fopen("Spi7_n6_Period_t240_R40.dat", "w");
fptAnc=    fopen("Spi7_n6_Anchor_t240_R40.dat", "w");
