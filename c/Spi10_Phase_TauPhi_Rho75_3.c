...
double gamma=0;
double rhos[]={0.75}, taus[]={5+EPSILON, 6, 7, 8, 9}, phis[]={0.13, 0.16, 0.19, 0.22, 0.25, 0.28, 0.31, 0.34,
...
fptPhase=fopen("Spi10_Phase_TauPhi_Rho75_3.dat", "w");
...
for(ic=0;ic<Len_cs;ic++){
	...
	phi=phis[iphi];
     ...
     strcat(filename,"_wave_3.dat");	
    strcat(filename2,"_map_3.dat");
