...
double gamma=0;
double rhos[]={0}, taus[]={300}, sigmas[]={0.5,0.6,0.7,0.8,0.9,1.1,1.3,1.5,1.8,2.1,2.4,2.9,3.4,3.9,4.6, 5, 5.4,6.3,7.4,8.7,10.2,12.0,14.0,16.5,19.3,22.6,26.5,31.1,36.4,42.7,50.0};
...
fptPhase=fopen("Spi6_b_Tauoff_Phase.dat", "w");
...
for(ic=0;ic<Len_cs;ic++){
	...
	rho=rhos[irho]; 
	tau_off=sigmas[isigma];	//Tau_off is not applied in LogNormal distribution
	tau=taus[itau]; 
	phi=0.43;
