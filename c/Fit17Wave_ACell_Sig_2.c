//The period of all the cells are considered.
...
double aglobal,as[]={0.02, 0.05, 0.02, 0.02};  //WT, trkA, sinR, ktrA
double tau, taus[]={300, 550, 300, 650};  
double cglobal, cs[]={10, 10, 10, 10};
double gamma=0, phi_real;
double phi,rho, phis[]={0.43, 0.43, 0.74, 0.51};
...
fpt=fopen("F17_4Strains_ACell_T.dat","w");
 fpt1=fopen("F17_4Strains_ACell_sta.dat","w");
