...
double gamma=0;
double rhos[]={0.75}, taus[]={12}, sigmas[]={0.42,  0.62,  0.88, 0.98};
...
fptPhase=fopen("Spi9_Phase_Tau12Rho75_test.dat", "w");
fptPeriod=fopen("Spi9_Period_Tau12Rho75_test.dat", "w");
fptAnc=    fopen("Spi9_Anchor_Tau12Rho75_test.dat", "w");
fptPhi=    fopen("Spi9_PhiAct_Tau12Rho75_test.dat", "w");
