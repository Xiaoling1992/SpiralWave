...
double gamma=0;
double rhos[]={0.74}, taus[]={9}, phis[]={0.6 ,  0.62,  0.64,  0.66,  0.68,  0.7 ,  0.72,  0.74,  0.76, 0.78,  0.8, 0.82, 0.84, 0.86, 0.88, 0.90, 0.92, 0.94, 0.96, 0.98, 1.0};
...
fptPeriod=fopen("Spi11_Period_Phi_Rho74Tau9.dat", "w");
fptPhi=    fopen("Spi11_PhiAct_Phi_Rho74Tau9.dat", "w");
