...
double gamma=0;
double rhos[]={0}, taus[]={44}, sigmas[]={0.41,0.411,0.412,0.413,0.415,0.417,0.42,0.423,0.428,0.433,0.44,0.45,0.461,0.476,0.495,0.519,0.549,0.588,0.637,0.7};
...
fptPhase=fopen("Spi511_b_Phase.dat", "w");
fptPeriod=fopen("Spi511_b_Period.dat", "w");
