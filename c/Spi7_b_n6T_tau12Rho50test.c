...
double gamma=0;
double rhos[]={0.50}, taus[]={12}, sigmas[]={0.5, 0.8};

int  NumRep=2, Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]),  Len_rhos=sizeof(rhos)/sizeof(rhos[0]), Len_taus=sizeof(taus)/sizeof(taus[0]), Len_sigmas=sizeof(sigmas)/sizeof(sigmas[0]);
...
fptPhase=fopen("Spi7_n6_Phase_t12Rho50.dat", "w");
fptPeriod=fopen("Spi7_n6_Period_t12Rho50.dat", "w");
fptAnc=    fopen("Spi7_n6_Anchor_t12Rho50.dat", "w");
