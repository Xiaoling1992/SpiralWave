...
double gamma=0;
double rhos[]={0}, taus[]={44}, sigmas[]={0.34, 0.36, 0.38};

int  Len_as=sizeof(as)/sizeof(as[0]), Len_cs=sizeof(cs)/sizeof(cs[0]), Len_taus=sizeof(taus)/sizeof(taus[0]), Len_sigmas=sizeof(sigmas)/sizeof(sigmas[0]), Len_rhos=sizeof(rhos)/sizeof(rhos[0]), NumRep=10;
...
fptPhase=fopen("Spi51_btest_Phase.dat", "w");
fptPeriod=fopen("Spi51_btest_Period.dat", "w");
