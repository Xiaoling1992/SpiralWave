...
fptPhase=fopen("Spi7_n3_Phase_t44.dat", "w");    //Change the name of the file: output. 
fptPeriod=fopen("Spi7_n3_Period_t44.dat", "w");
fptAnc=    fopen("Spi7_n3_Anchor_t44.dat", "w");
