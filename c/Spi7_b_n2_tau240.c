...
fptPhase=fopen("Spi7_n2_Phase_t240.dat", "w");
fptPeriod=fopen("Spi7_n2_Period_t240.dat", "w");
fptAnc=    fopen("Spi7_n2_Anchor_t240.dat", "w");
 ...
 //$$ 4. Change the Trigger Time,length, and number of rows $$$$$$$$$$$$$$$$*//  
  ...
  if ( LocEnd== -1 )
	...
	for (i=0; i<N; i++){  
	 ...
	 int state[N*M], cluster[N*M], numerator=0, denominator=0, CluSiz;  //Initiation
