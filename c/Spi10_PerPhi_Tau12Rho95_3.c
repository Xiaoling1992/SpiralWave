...
double gamma=0;
double rhos[]={0.95}, taus[]={12}, phis[]={ 0.72,  0.74,  0.76, 0.78,  0.8, 0.82, 0.84 };
...
fptPeriod=fopen("Spi10_Period_Tau12Rho95_3.dat", "w");
fptPhi=    fopen("Spi10_PhiAct_Tau12Rho95_3.dat", "w");
