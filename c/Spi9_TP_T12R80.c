...
double gamma=0;
double rhos[]={0.80}, taus[]={12}, sigmas[]={0.42,  0.44,  0.46,  0.48,  0.5 ,  0.52,  0.54,  0.56,  0.58, 0.6 ,  0.62,  0.64,  0.66,  0.68,  0.7 ,  0.72,  0.74,  0.76, 0.78,  0.8, 0.82, 0.84, 0.86, 0.88, 0.90, 0.92, 0.94, 0.96, 0.98};
...
fptPhase=fopen("Spi9_Phase_Tau12Rho80.dat", "w");
fptPeriod=fopen("Spi9_Period_Tau12Rho80.dat", "w");
fptAnc=    fopen("Spi9_Anchor_Tau12Rho80.dat", "w");
fptPhi=    fopen("Spi9_PhiAct_Tau12Rho80.dat", "w");
