...
double gamma=0;
double rhos[]={0.95}, taus[]={12}, phis[]={ 0.86, 0.88, 0.90, 0.92, 0.94, 0.96, 0.98 };
...
fptPeriod=fopen("Spi10_Period_Tau12Rho95_4.dat", "w");
fptPhi=    fopen("Spi10_PhiAct_Tau12Rho95_4.dat", "w");
