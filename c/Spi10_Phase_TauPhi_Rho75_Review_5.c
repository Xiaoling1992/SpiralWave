...
double gamma=0;
double rhos[]={0.75}, taus[]={5+EPSILON, 6, 7, 8, 9, 10, 12, 14, 16, 19, 22, 26, 30, 36, 42, 49, 57, 67, 79, 92, 108, 127, 149, 174, 204, 
...
fptPhase=fopen("Spi10_Phase_TauPhi_Rho75_5.dat", "w");
