...
double gamma=0;
double rhos[]={0.52,  0.54,  0.56,  0.58, 0.6 ,  0.62,  0.64,  0.66,  0.68,  0.7 ,  0.72,  0.74,  0.76, 0.78,  0.8, 0.82, 0.84, 0.86, 0.88, 0.90, 0.92, 0.94, 0.96, 0.98}, taus[]={12}, phis[]={0.8};
...
fptPeriod=fopen("Spi10_Period_Rho_Tau12Phi80.dat", "w");
fptPhi=    fopen("Spi10_PhiAct_Rho_Tau12Phi80.dat", "w");
   

for(irho=0; irho<Len_rhos; irho++){
for(itau=0;itau<Len_taus;itau++){
  double period[Len_phis][NumRep], PhiAct[Len_phis][NumRep];
