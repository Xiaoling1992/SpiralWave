...
double gamma=0;
double rhos[]={0.25}, taus[]={12}, sigmas[]={0.42,  0.44,  0.46,  0.48,  0.5 ,  0.52,  0.54,  0.56,  0.58, 0.6 ,  0.62,  0.64,  0.66,  0.68,  0.7 ,  0.72,  0.74,  0.76, 0.78,  0.8};
...
fptPhase=fopen("Spi8_Phase_t12Rho25.dat", "w");
fptPeriod=fopen("Spi8_Period_t12Rho25.dat", "w");
fptAnc=    fopen("Spi8_Anchor_t12Rho25.dat", "w");
