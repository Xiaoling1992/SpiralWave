//Spi4.8: use the wavefront at time t* as the dependence to decide whether it is a break up or not. (To tell breaking spiral from secondary spiral.)
...
fptPhase=fopen("Spi5_b_Phase.dat","w");
