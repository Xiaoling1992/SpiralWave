...
double gamma=0;
double rhos[]={0.0}, taus[]={12}, sigmas[]={0.42,  0.44,  0.46,  0.48,  0.5 ,  0.52,  0.54,  0.56,  0.58,
...
fptPhase=fopen("Spi7_n6_Phase_t12Rho0.dat", "w");
fptPeriod=fopen("Spi7_n6_Period_t12Rho0.dat", "w");
fptAnc=    fopen("Spi7_n6_Anchor_t12Rho0.dat", "w");
