...
int N=1000, M=1000, Leng=N*M, print=1,coefx=1,coefy=1;   //N, the number of rows, M, the number of columns.
...
fptAnc=    fopen("Spi7_MClu_Phi_N1000.dat", "w");
 time_t tt;
...
for(ip=0;ip<NumRep; ip++){         
    ...
    CluGen_G5_1(tauNoise, N, M, phi, 0 , tau_off, tau, 1, 1, 0, 1, 0);
