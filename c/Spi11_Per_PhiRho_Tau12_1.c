...
double gamma=0;
double rhos[]={0.80, 0.82, 0.84, 0.86, 0.88, 0.90, 0.92, 0.94, 0.96, 0.98}, taus[]={12}, phis[]={0.90, 0.92, 0.94, 0.96, 0.98};
...
fptPeriod=fopen("Spi11_Period_PhiRho_Tau12_1.dat", "w");
fptPhi=    fopen("Spi11_PhiAct_PhiRho_Tau12_1.dat", "w");
