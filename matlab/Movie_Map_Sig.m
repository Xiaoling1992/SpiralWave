...
dd='/home/xiaoling/SpiralWave/data/';                  
 ...
 matrix=load([dd,'Spi7_n6_2Rho0t240p340c10_wave.dat']);  
 map=load([dd,'Spi7_n6_2Rho0t240p340c10_map.dat']); 
...
vidobj = VideoWriter('../PapFig/Spi7_n6_2Rho0t240p340c10.avi','Motion JPEG AVI');
open(vidobj);
%a=max(max(data))
%b=min(min(data))
for it=1:1:length(t)
   ...
   t_str=['t=' num2str(t(it))]; %Generate the time string
    title(['Time: ' t_str, ' \tau=240', ' \phi=0.34']);
    fr = getframe(gcf);
