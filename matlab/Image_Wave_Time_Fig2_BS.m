...
matrix=load([dd,'Spi7_bRho75t22p58c10_wave.dat']);  
...
%       if(i==1)
%        annotation('textarrow', [0.4, 0.5],[0.4, 0.3]+0.07, 'Color', 'r', 'LineWidth',3); 
%     elseif(i==2)
%        annotation('textarrow', [0.4, 0.5]-0.04,[0.4, 0.4]+0.05, 'Color', 'r', 'LineWidth',3); 
%     elseif(i==3)
%         annotation('textarrow', [0.6, 0.5]+0.04,[0.3, 0.3]+0.02, 'Color', 'r', 'LineWidth',3); 
%     else
%         annotation('textarrow', [0.4, 0.5],[0.4, 0.3]+0.07, 'Color', 'r', 'LineWidth',3); 
%     end
...
%    set(gca,'xtick',[1:length(phis)],'xticklabel',phis([1:length(phis)]),'ytick',1:length(taus),'yticklabel',taus);
   ...
   %print(gcf,['../PapFig/Spi7_bRho75t22p58c10_T',num2str( time(i) ),'.png'],'-dpng','-r400');
