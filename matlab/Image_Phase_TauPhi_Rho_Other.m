...
%     set(gca,'xtick',[])
%     set(gca, 'ytick',[])
text(find(phis==0.37), find(taus==452), 'C','FontSize',20, 'FontWeight','bold','color','k' )
text(find(phis==0.58), find(taus==22), 'D', 'FontSize',20,'FontWeight','bold','color','k' )
 
print(gcf,['../PapFig/Image_Phase_TauPhi_Rho0_Other.png'],'-dpng','-r500');
