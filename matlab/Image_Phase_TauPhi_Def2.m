...
taus=[7, 8, 9, 10, 12, 14, 16, 19, 22, 26, 30, 36, 42, 49, 57, 67, 79, 92, 108, 127, 149, 174, 204, 240, 281, 329, 386, 452, 530, 621, 728, 853, 1000];
...
data=zeros( len(taus)*len(phis), 20)
data(1:3)= load(['/home/xiaoling/SpiralWave/data/Spi10_Phase_TauPhi_Rho75.dat']);
...
%     set(gca,'xtick',[])
%     set(gca, 'ytick',[])
text(find(phis==0.37), find(taus==452), 'E','FontSize',20, 'FontWeight','bold','color','k' )
text(find(phis==0.58), find(taus==22), 'F', 'FontSize',20,'FontWeight','bold','color','k' )
 
print(gcf,['../PapFig/Image_Phase_TauPhi_Rho75_Spi10.png'],'-dpng','-r500');
