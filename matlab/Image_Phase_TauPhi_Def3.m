...
data(1:5*length(phis), :)= load(['/home/xiaoling/SpiralWave/data/Spi10_Phase_TauPhi_Rho0_3.dat']);
data(5*length(phis)+1:end, :)= load(['/home/xiaoling/SpiralWave/data/Spi10_Phase_TauPhi_Rho0_1.dat']);
...
%     set(gca,'xtick',[])
%     set(gca, 'ytick',[])
text( 0.37-0.02, find(taus==452), 'C','FontSize',20, 'FontWeight','bold','color','k' )
text( 0.64-0.02, find(taus==14), 'D', 'FontSize',20,'FontWeight','bold','color','k' )
 
print(gcf,['../PapFig/Image_Phase_TauPhi_Rho0_Spi10_3.png'],'-dpng','-r500');
