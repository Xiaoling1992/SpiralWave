...
dd='/home/xiaoling/SpiralWave/data/';
  ...
  matrix=load([dd,'Spi11Rho95Phi500t9c10_wave.dat']);  
...
%matrix=load('/home/xiaoling/Fitzhugh/data/Fit8a1l10b8.dat');
 nvth=load([dd,'Spi11Rho95Phi500t9c10_map.dat']); 
...
vidobj = VideoWriter('../PapFig/Spi11Rho95Phi500t9c10.avi','Motion JPEG AVI');
vidobj.FrameRate = 10;
vidobj.Quality = 75;
...
for it=1:1:length(t)
   ...
   title(['Time: ' t_str, ' \tau=9', ' \phi=0.50']);
    fr = getframe(gcf);
