...
phase_Pre(phase_Pre==0)   =1;
phase_Pre( phase_Pre==3 )=5;
phase_Pre( (phase_Pre==2) )=3;
phase_Pre(  (phase_Pre==8)  )=3;
phase_Pre( (phase_Pre==9) )=3;

phase_Pre( phase_Pre==5 )=2;
...
%print(gcf,['../PapFig/Image_Phase_MeanVariance_LN_Other.png'],'-dpng','-r400');
